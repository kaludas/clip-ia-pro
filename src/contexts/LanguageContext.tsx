...
const translations = {
  fr: {
    ...
    "pricing.pro.f6": "Logo/Branding personnalisé",
    ...
    "pricing.agency.f2": "5 comptes utilisateurs",
    "pricing.agency.f3": "Recadrage multi-sources",
    "pricing.agency.f4": "API privée",
    "pricing.agency.f5": "Formation personnalisée",
  ...
  en: {
    ...
    "pricing.pro.f6": "Custom logo/branding",
    ...
    "pricing.agency.f2": "5 user accounts",
    "pricing.agency.f3": "Multi-source cropping",
    "pricing.agency.f4": "Private API",
    "pricing.agency.f5": "Custom training",
